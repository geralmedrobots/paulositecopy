...
function Projects() {
  ...
  return <>
    ...
    <section className="project-cta"><div className="container"><p className="eyebrow">Research and integration</p><h2>Talk to Med Robots about hospital logistics.</h2><Button to="/contacts">Contact Us</Button></div></section>
  </>;
}
