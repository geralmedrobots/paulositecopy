...
function Home() {
  return <>
    <Hero className="hero--home" kicker="Hospital robotics · Autonomous logistics" title="The Future of Hospital Logistics" lead="Med Robots develops and integrates autonomous robotic solutions for the complex logistics of hospital operations." primaryCta={{ to: "/solutions", label: "Explore Our Solutions" }} secondaryCta={{ to: "/contact", label: "Contact Us" }} />
    ...
    <section className="home-cta"><div className="container"><p className="eyebrow">The next shift in hospital operations</p><h2>Building the autonomous hospital infrastructure of tomorrow.</h2><Button to="/contact">Talk to Med Robots</Button></div></section>
  </>;
}
export default Home;
